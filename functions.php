...
function unlimited_register_widget_areas(){
    ...
    register_sidebar( array(
        'name'          => __( 'AfterContent', 'unlimited' ),
        'id'            => 'aftercontent',
        'description'   => __( 'Unter dem Seiteninhalt', 'unlimited' ),
...
//		return $output . "<p><a class='more-link' href='" . get_permalink() . "'>" . __( 'Read More', 'unlimited' ) . "<span class='screen-reader-text'>" . get_the_title() . "</span></a></p>";
		return $output . "<a class='more-link' href='" . get_permalink() . "'>weiterlesen<!--span class='screen-reader-text'>" . get_the_title() . "</span--></a>";
	}
}
